    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
      <div className="w-full max-w-sm rounded-xl border border-white/10 bg-[#141414] p-6 text-center">
        ...
        <div className="mt-5 flex justify-center gap-3">
          <button
            onClick={onEsperar}
            className="rounded-md px-4 py-2 text-base font-medium text-white/60 hover:text-white"
          >
            Esperar su horario
          </button>
          <button
            onClick={onIniciar}
            className="rounded-md bg-brand px-4 py-2 text-base font-bold text-sobre-brand hover:bg-brand-strong"
          >
            Iniciar ahora
          </button>
        </div>
