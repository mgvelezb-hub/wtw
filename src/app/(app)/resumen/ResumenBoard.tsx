...
export function ResumenBoard({
  ...
  return (
    <div className="space-y-4">
      <header>
        <h1 className="text-lg font-bold text-[#0c4a45]">Resumen con IA</h1>
      ...
      <section className="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm">
        <h2 className="text-xs font-bold uppercase tracking-wide text-[#0c4a45]">Alcance</h2>
          ...
          {ALCANCES.map((a) => (
            <button
              ...
              className={`rounded-full px-3 py-1 text-xs font-bold ${
                clave === a.clave ? 'bg-[#0c4a45] text-white' : 'bg-neutral-100 text-neutral-600 hover:bg-neutral-200'
              }`}
            >
              {a.label}
            </button>
        ...
        <button
          ...
          onClick={generar}
          className="mt-3 w-full rounded-full bg-[#0c4a45] px-4 py-2 text-sm font-bold text-white disabled:opacity-40"
        >
      ...
      {texto !== null && (
        <section className="rounded-xl border-2 border-[#0c4a45] bg-white p-4 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <h2 className="text-xs font-bold uppercase tracking-wide text-[#0c4a45]">Resumen</h2>
            <div className="flex gap-1.5">
              <button
                ...
                className="rounded-full border border-[#0c4a45] px-3 py-1 text-xs font-bold text-[#0c4a45]"
              >
                Copiar
              </button>
              <button
                ...
                className="rounded-full bg-[#e8b94a] px-3 py-1 text-xs font-bold text-[#4a3a10] disabled:opacity-40"
              >
                Guardar edición
              </button>
            </div>
          ...
          {guardado && <p className="mt-1 text-xs text-[#0c4a45]">Versión editada guardada.</p>}
      ...
      {previos.length > 0 && (
        <section className="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm">
          <h2 className="text-xs font-bold uppercase tracking-wide text-[#0c4a45]">Resúmenes anteriores</h2>
