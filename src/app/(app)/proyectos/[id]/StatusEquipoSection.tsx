    ...
    <section className="hair pt-6">
      ...
      <div className="rounded-lg border border-edge bg-surface p-3">
        <button
          ...
          onClick={alGenerar}
          disabled={pending}
          className="rounded-md bg-brand-deep px-3 py-1.5 text-sm font-semibold text-sobre-brand disabled:opacity-50"
        >
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                onClick={alCopiar}
                disabled={pending}
                className="rounded-md bg-brand px-3 py-1.5 text-sm font-semibold text-sobre-brand disabled:opacity-50"
              >
