...
// /dia. Se eliminó: mover PRIMERO le cambiaba `fecha` a los bloques en el mismo
// registro, y como lo planeado se calcula leyendo bloques por fecha, el día
// quedaba en cero y la reconciliación se volvía imposible. Fue lo que pasó el
// 13-ago-2026.
//
// Ahora mover es el ÚLTIMO paso del cierre y vive en
// `src/app/(app)/cierre/actions.ts` → `pasarPendientesAction`, que toma el
// snapshot antes de mover. El botón de /dia solo navega a /cierre.
