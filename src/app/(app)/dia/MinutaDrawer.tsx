  ...
  return (
    <button
      ...
      className={`rounded-full border px-2.5 py-1 text-xs font-semibold ${
        active ? 'border-brand-deep bg-brand-deep text-sobre-brand' : 'border-hair text-muted hover:border-brand-strong hover:text-brand-strong'
      }`}
    >
      {TIPO_LABEL[tipo]}
    </button>
          ...
          <>
            ...
            <div className="mt-5 border-t border-hair pt-4">
              ...
              <button
                ...
                onClick={guardarItem}
                className="mt-2 w-full rounded-md bg-brand px-3 py-2 text-sm font-bold text-sobre-brand hover:bg-brand-strong disabled:opacity-50"
              >
                + Agregar item
              </button>
                ...
                <div className="mt-2 rounded-md border-2 border-brand-deep bg-surface p-2">
                  ...
                  <div className="mt-2 flex gap-1.5">
                    <button
                      ...
                      className="flex-1 rounded-md bg-brand-deep px-3 py-1.5 text-sm font-bold text-sobre-brand disabled:opacity-50"
                    >
